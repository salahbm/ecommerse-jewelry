...
// internal
import about_img from '../../../../public/assets/img/about/about-1.jpg'
import about_thumb from '../../../../public/assets/img/about/about-2.jpg'
            ...
            <div className="col-xl-7 col-lg-6">
              <div className="tp-about-wrapper pl-80 pt-75 pr-60">
                ...
                <div className="tp-about-content pl-120">
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /> Cras vel mi
                    quam. Fusce vehicula vitae mauris sit amet tempor. Donec consectetur lorem ipsum
